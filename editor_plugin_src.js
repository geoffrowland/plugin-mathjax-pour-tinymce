...
(function() {
    ...
    tinymce.create('tinymce.plugins.MathjaxPlugin', {
        ...
        //Elle est appelée à deux reprises : 1. lorsque l'éditeur est chargé 2. Lorsque l'utilisateur met à jour le code html via l'éditeur de code
        _marqueMath : function(content){
            var text = this._cleanMath(content);
            //on nettoie les résidues avant toute chose ...
            var newtext = ""
